...
<html>
    ...
    <body>
        ...
        <div id="show-config" class="content scaffold-show" role="main">
            ...
            <f:display bean="config" />
            <g:form resource="${this.config}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.config}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
