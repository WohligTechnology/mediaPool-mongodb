...
<html>
    ...
    <body>
        ...
        <div id="edit-board" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.board}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.board}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.board}" method="PUT">
                <g:hiddenField name="version" value="${this.board?.version}" />
                <fieldset class="form">
                    <f:all bean="board"/>
                </fieldset>
